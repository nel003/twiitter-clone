...
export function Apple({ className }: { className?: string }): JSX.Element {
  return (
    <>
      <svg
        className={className || ""}
...
export function Eye({ className }: { className?: string }): JSX.Element {
  return (
    <>
      <svg
        className={className || ""}
...
export function EyeOff({ className }: { className?: string }): JSX.Element {
  return (
    <>
      <svg
        className={className || ""}
